...
export default function TermsPage() {
  ...
  const termsViewed = usePolicyStore((state) => state.termsViewed);
  const setTermsViewed = usePolicyStore((state) => state.setTermsViewed);
  const [isChecked, setIsChecked] = useState(termsViewed);

  // Sync local state with Zustand when it changes
  useEffect(() => {
    setIsChecked(termsViewed);
  }, [termsViewed]);
        ...
        <CardContent>
          ...
          <Box mt={4}>
            ...
            <Typography paragraph>
              ...
              relationships, contracts, and work arrangements are directly
              between users.
            </Typography>
            ...
            <Typography paragraph>
              ...
              2004, Health and Safety at Work Act 2015, and Fair Trading Act
              1986.
            </Typography>
            ...
            <Typography paragraph fontWeight="medium" sx={{ mt: 1 }}>
              Tradirise does NOT verify, endorse, or guarantee any user,
              listing, or service. Any verification badges or profile indicators
              are user-provided information only and do not constitute our
              endorsement or guarantee of quality, safety, or suitability.
            </Typography>
            ...
            <Typography paragraph>
              Tradirise STRONGLY RECOMMENDS that:
            </Typography>
            <Typography component="ul" sx={{ pl: 4 }}>
              <li>
                All tradespeople maintain public liability insurance (minimum
                $1-2 million) and professional indemnity insurance
              </li>
              <li>
              ...
              <li>
                All users obtain appropriate insurance for their activities
              </li>
            </Typography>
            <Typography paragraph>
              We do NOT verify insurance status. Insurance information on
              profiles is user-provided and not verified by Tradirise. It is
              YOUR responsibility to request and verify current insurance
              certificates.
            </Typography>
            ...
            <Typography paragraph>
              All users are responsible for compliance with the Health and
              Safety at Work Act 2015 and all applicable safety regulations.
              Tradirise has NO responsibility for:
            </Typography>
            <Typography component="ul" sx={{ pl: 4 }}>
            ...
            <Typography component="ul" sx={{ pl: 4 }}>
              ...
              <li>
                Disclose known hazards (e.g., asbestos, electrical issues)
              </li>
            ...
            <Typography paragraph fontWeight="bold">
              You agree to indemnify, defend, and hold harmless Tradirise and
              its owner from any and all claims, damages, losses, liabilities,
            ...
            <Typography paragraph>
              Only positive endorsements or recommendations may be displayed.
              The absence of negative feedback does not imply overall
              performance, suitability, or reliability.
            </Typography>

            <Typography paragraph fontWeight="medium">
              You remain solely responsible for conducting your own due
              diligence before engaging any business or individual.
            </Typography>
            ...
            <Typography component="ul" sx={{ pl: 4 }}>
              ...
              <li>
                Attempt to circumvent the Platform to avoid fees (e.g.,
                exchanging contact details to transact off-platform)
              </li>
              <li>
            ...
            <Typography paragraph fontWeight="medium">
              Violation may result in immediate account termination, forfeiture
              of subscription fees, and potential legal action.
            </Typography>
            ...
            <Typography paragraph>
              ...
              display, and distribute that content for the operation and
              promotion of the Platform.
            </Typography>
            <Typography paragraph>
              All Platform materials, branding, software, and design are the
              intellectual property of Tradirise and may not be copied,
            ...
            <Typography component="ul" sx={{ pl: 4 }}>
              ...
              <li>
                That the Platform will always be available, secure, or
                error-free
              </li>
              <li>
              ...
              <li>
                That jobs, opportunities, or listings are legitimate,
            ...
            <Typography component="ul" sx={{ pl: 4 }}>
              ...
              <li>
                ...
                through the Platform (except where caused by our gross
            ...
            <Typography paragraph fontWeight="medium" sx={{ mt: 2 }}>
              This limitation applies regardless of the form of action, whether
              in contract, tort (including negligence), statute, or otherwise.
            </Typography>
            ...
            <Typography paragraph>
              ...
              business purposes, you acknowledge and agree that the provisions
              of the Consumer Guarantees Act 1993 do not apply.
            </Typography>
            ...
            <Typography paragraph>
              Users must first attempt to resolve any disputes directly with
              each other in good faith. The Platform may provide messaging tools
              but is not responsible for facilitating or mediating disputes.
            </Typography>
            ...
            <Typography paragraph>
              ...
              agree to use the New Zealand Disputes Tribunal as the primary
              forum for resolution before pursuing other legal action.
            </Typography>
            ...
            <Typography paragraph fontWeight="medium">
              ...
              individually and not as part of any class action, collective
              action, or representative proceeding. You waive any right to
              participate in a class action against Tradirise.
            </Typography>
            ...
            <Typography paragraph>
              ...
              version on the Platform with an updated &#34;Last Updated&#34;
              date. Material changes will be notified via email or prominent
              notice on the Platform. Continued use of the Platform after
                  ...
                  control={
                    <Checkbox
                      ...
                      onChange={(e) => {
                        ...
                        setTermsViewed(e.target.checked);
                      }}
                    />
                  }
                  label={
