// components/ContactProjectDialog.tsx
"use client";
...
interface ContactProjectDialogProps {
  open: boolean;
  onClose: () => void;
  projectId: string;
  projectTitle: string;
...
const ContactProjectDialog: React.FC<ContactProjectDialogProps> = ({
  open,
  onClose,
  projectId,
  projectTitle,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("/api/projects/contact", {
        method: "POST",
        headers: {
        ...
        <DialogContent>
          ...
          {success && (
            <Alert severity="success" sx={{ mb: 2 }}>
              Application sent successfully! The project owner will receive your
              contact details.
            </Alert>
          )}
...
export default ContactProjectDialog;
