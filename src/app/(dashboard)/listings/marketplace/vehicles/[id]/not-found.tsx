// app/listings/marketplace/vehicles/[id]/not-found.tsx
      ...
      <Center sx={{ minHeight: "60vh" }}>
        <Box textAlign="center">
          <Box color="text.secondary" sx={{ opacity: 0.3, mb: 2 }}>
            <Icon icon="mdi:car-off" width={80} height={80} />
          </Box>
          ...
          <Typography variant="body2" color="text.secondary" mb={3}>
            The vehicle listing could not be found or may have been removed
          </Typography>

          <Flex gap={2} justifyContent="center" flexWrap="wrap">
            <Button
              component={Link}
              href="/listings/marketplace?tab=vehicles"
              variant="contained"
              size="small"
